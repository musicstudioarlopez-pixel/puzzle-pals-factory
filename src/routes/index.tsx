...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fabricante de quebra-cabeças educativos infantis. Venda no atacado a partir de R$ 3,99/un para revenda. Histórias Bíblicas, Princesas, Sonic, Bob Esponja, Turma da Mônica, Mundo Bita e mais." },
        ...
        <div className="mx-auto max-w-5xl px-5">
          <div className="relative rounded-[2.5rem] bg-gradient-fun p-10 md:p-16 text-primary-foreground shadow-pop overflow-hidden">
            ...
            <h2 className="mt-4 text-4xl md:text-6xl font-extrabold text-balance" style={{ fontFamily: "Fredoka" }}>
              R$ 3,99 por unidade<br/>a partir de 1000 unidades
            </h2>
